package org.firstinspires.ftc.teamcode.components.lib.drive.util;
...
public final class LogFiles {
    ...
    public static class LogFile {
        ...
        public double mecTransP = Chassis.TRANSLATIONAL_PID.kP;
        public double mecTransI = Chassis.TRANSLATIONAL_PID.kI;
        public double mecTransD = Chassis.TRANSLATIONAL_PID.kD;
        public double mecHeadingP = Chassis.HEADING_PID.kP;
        public double mecHeadingI = Chassis.HEADING_PID.kI;
        public double mecHeadingD = Chassis.HEADING_PID.kD;
        public double mecLateralMultiplier = Chassis.LATERAL_MULTIPLIER;
