...
public class FirstTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.a) {arm.setState(NewArm.ArmState.intake); arm.intake = 0; drone.home(); arm.pivot = false;}
            else if (gamepad2.x) {arm.setState(NewArm.ArmState.outtake); arm.intake = 2; arm.pivot = false;}
            else if (gamepad2.y) {arm.setState(NewArm.ArmState.hang); drone.prepareLaunch(); arm.intake = 2; arm.pivot = false;}
            ...
            if (gamepad2.dpad_left) {arm.setState(NewArm.ArmState.level1); arm.intake = 1; arm.pivot = true;}
