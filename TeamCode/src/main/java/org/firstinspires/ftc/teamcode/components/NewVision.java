...
//        visionPortal.close();
    ...
    public int getIndicator() {
        ...
        if(indicatorProcessor.getIndicator().empty()) return -1;
        else if(indicatorProcessor.getIndicator().x < (screenWidth/3)) return 1;
        else if(indicatorProcessor.getIndicator().x > (screenWidth*2/3)) return 3;
        else return 2;
    }
